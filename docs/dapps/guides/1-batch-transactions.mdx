...
:::info Try it Live
Try a [live demo](https://batch-transactions-demo-web3onboard.netlify.app/) using [Candide Wallet](https://candidewallet.com) and WalletConnect. 
      ...
      <div>
        ...
        {account && (
          <div>
            <button onClick={sendBundledCalls}>Send Bundled Txs</button>
            // highlight-start
            <button onClick={() => getBundleStatus(txHash)} disabled={!txHash}>
              Check Bundle Status
            </button>
