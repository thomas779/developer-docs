...
:::note 
We will often import WebAuthn API helper functions and classes from [/webauthn](https://github.com/candidelabs/abstractionkit/blob/main/examples/SafeAccountExamples/WebAuthnCreateAccountAndSendTransaction/src/webauthn.ts). Make sure to copy it and using it during your developement. 
:::
...
It’s important to consider a multisig setup or the recovery module when using Passkeys. 
