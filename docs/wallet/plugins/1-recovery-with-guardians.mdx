...
and for multi-sig accounts. An account owner can add recovery methods (also known as Guardians) 
...
:::note
We're installing `v0.1.7` of `abstractionkit`, an experimental version that includes the Guardian Recovery Module.
:::
...
<Tabs>
  <TabItem value="Param type" label="Param Types">
    <SdkParamsTable items={getRecoveryHashParams} />
  </TabItem>
  <TabItem value="Return type" label="Return Types">
    <p>Recovery Hash</p>
  </TabItem>
