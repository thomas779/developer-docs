...
:::info
Want to run a simple example? Start by adding your first guardian [here](https://github.com/candidelabs/abstractionkit/tree/webauth/examples/SafeAccountExamples/SocialRecovery). 
:::
