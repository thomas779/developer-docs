...
- Deployment addresses for different grace periods can be found [here](/docs/wallet/technical-reference/deployments/#social-recovery-module).
...
:::note
We're installing `v0.1.16` of `abstractionkit`, the beta version of the SDK that includes the Guardian Recovery Module.
:::
...
a [different grace period address](/docs/wallet/technical-reference/deployments/#social-recovery-module)
