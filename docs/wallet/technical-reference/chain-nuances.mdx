...
Using the [createUserOperation](../abstractionkit/safe-account/#createuseroperation) function, developers can pass their own values for `maxPriorityFeePerGas` and `maxFeePerGas`, ensuring reliable transaction processing.
