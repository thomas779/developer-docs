...
- Some Candide Test Tokens (CTT). Request CTT on our Discord or [telegram](https://t.me/heymarcopolo)
...
:::info
Don't forget to fund the account with ERC-20s to pay for gas. We are using Candide Test Tokens (CTT). Request some on [telegram](https://t.me/heymarcopolo) or Discord.
:::
