...
If you are coming from the [previous guide](../getting-started), you can skip directly to [step 3](./#step-3-generate-the-calldata).
...
We will be constructing the callData using [createCallData](../../abstractionkit/candide-account/#createcalldata), which returns the instructions to send our transaction on-chain.
