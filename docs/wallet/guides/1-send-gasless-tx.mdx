...
- If you need, the full example of this tutorial on [Github](https://github.com/candidelabs/abstractionkit/tree/main/examples/SafeAccountExamples/CreateAccountAndSendTransactionUsingSponsorPaymaster)
...
:::info
Sponsored Policies are in beta. Get an beta API key from us on [telegram](https://t.me/heymarcopolo)
:::
