...
:::info
Gassless Policies Txs are in Beta. Use this public API to sponsor gas on Sepolia and Amoy Testnet. Need an API key for Mainnets? Reach out on discord.
...
- If you need, fork the full example of this tutorial on [Github](https://github.com/candidelabs/abstractionkit/tree/main/examples/SafeAccountExamples/CreateAccountAndSendTransactionUsingSponsorPaymaster)
