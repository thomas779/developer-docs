...
[createCallDataSingleTransaction](https://github.com/candidelabs/abstractionkit/blob/831c665c65eafa012b1ec26210cdd993401fcab3/src/account/Candide/CandideAccount.ts#L225)
...
const callData = smartAccount.createCallDataSingleTransactionWithPaymaster(
  tx,
  paymaster: "0x3fe285dcd76bcce4ac92d38a6f2f8e964041e020", // Candide Paymaster Address
  approveToken: "0x7DdEFA2f027691116D0a7aa6418246622d70B12A", // CTT ERC-20 Testnet Token address
  approveAmount: "0xffd4fdfb6ee21e", // approve amount for the paymaster- to pay for gas using erc20 token
);
...
<TabItem value="Param type" label="Param Types">
  <table>
    ...
    <tbody>
      ...
      <tr>
        <td align="left">approveAmount</td>
        <td align="left">
          <p>BigNumberish</p>
        </td>
