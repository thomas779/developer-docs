...
The `CandideAccount` is a class that implements [CandideWallet.sol](https://github.com/candidelabs/CandideWalletContracts), a compliant EIP-4337 smart contract account based on Safe v1.4.1 contracts. 

Learn more in details about the implementation details in [Unbundling Candide core wallet contract](/blog/unbundling-candide-core-wallet-contract).
