...
The `SafeAccount` uses the original Safe Singlton and adds ERC-4337 functionality using a sepcial FallBack Handler Module.

:::caution
The details of the implementation is currently being tested and is in active developement. If you would like to try it out, pull AbstractionKit locally from github and checkout on the [Safe branch](https://github.com/candidelabs/abstractionkit/tree/safe).
:::
