...
<table>
  <thead>
    ...
    <th align="left">Advanced</th>
      ...
      <tr>
        <td></td>
        <td><a href="https://github.com/candidelabs/abstractionkit/blob/0c363636cd97d47cac39e4e6b8daf4283710adde/src/account/Safe/SafeAccountV0_2_0.ts#L484C15-L484C39">estimateUserOperationGas</a></td>
      </tr>
    </tbody>
</table>
...
let userOperation = await smartAccount.createUserOperation(
  ...
  jsonRpcNodeProvider,
  bundlerUrl,
  { initCode: initCode } // only needed for the first userOp to deploy the account
)
// highlight-end
