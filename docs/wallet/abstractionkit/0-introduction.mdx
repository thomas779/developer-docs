...
description: A simple typescript library to build and send UserOperations
...
A Typescript Library to easily build and send ERC-4337 UserOperations
...
Seamlessly use Smart Accounts Implentations, construct callData, estimate and sponsor gas (completly or with ERC-20 tokens), send UserOps to Bundlers and more – all while benefiting from being type-safe.
