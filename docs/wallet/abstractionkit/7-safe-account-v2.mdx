...
import {
  ...
  createAddOwnerWithThresholdMetaTransactionParams,
  createAddOwnerWithThresholdMetaTransactionReturn,
...
### createAddOwnerWithThresholdMetaTransaction
...
<Tabs>
<TabItem value="Param type" label="Param Types">
  <DataTable items={createAddOwnerWithThresholdMetaTransactionParams} />
</TabItem>
<TabItem value="Return type" label="Return Types">
  <DataTable items={createAddOwnerWithThresholdMetaTransactionReturn} />
</TabItem>
</Tabs>
