...
description: JSON-RPC API reference for Candide's Verifying Paymaster service
---
...
Sends a UserOperation to a paymaster for off-chain verification. If approved, it will return the paymasterData signature. If the paymaster rejects the UserOperation it should not return a result but a standard JSON-RPC error with the reason.
  ...
  <table>
    ...
    <tbody>
      <tr>
        ...
        <td align="left">
          Address of paymaster sponsoring the transaction, followed by the
          paymaster signature
        </td>
      </tr>
    </tbody>
...
<TabItem value="request type" label="Request Type">
  <table>
    <thead>
      <th align="left">Paramater</th>
      <th align="left">Type</th>
